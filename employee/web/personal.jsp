...
<script src="/employee/layui/layui.js"></script>
<style>
	  .item label{
...
<%--			  逻辑判断   ${}:EL表达式           --%>
			  <c:if test="${not empty user.img}">
				  <img id="img" style="position:absolute;left:130px;bottom: -25px;  width: 90px;height: 90px;border-radius: 100%"
					   src="${user.img}" />
			  </c:if>
...
<%--		  </script>--%>
      ...
      <div class="form-group">
        ...
        <div class="field">
          <textarea type="text" class="input" name="note" style="height:120px;" value="">
			  ${user.description}
		  </textarea>
          <div class="tips"></div>
        </div>
