	...
	<div class="header bg-main">
		...
		<div class="head-l"><a class="button button-little bg-green" href="" target="_blank"><span class="icon-home"></span>
			...
			&nbsp;&nbsp;<a class="button button-little bg-red"
						   onclick="logOut()"
						   href="javascript:void(0)"><span class="icon-power-off"></span> 退出登录</a>
		</div>
		<div class="logo margin-big-right fadein-top" style="margin-left: 650px;">
			<h4>欢迎，<span style="font-family: 幼圆;color: pink;font-size: 20px;font-weight: bold;">${user.username}</span></h4>
		</div>
	</div>
	<div class="leftnav">
...
<script>
	function logOut(){
		let logOut = confirm("确认退出？");
		if(logOut){
			location.href="/employee/user?method=logout";
		}
	}
</script>