...
public class JDBCTest {
    ...
    public void testUpdate() throws Exception {
        ...
        // 1.2获取数据库连接对象  Connection
        //Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/java147_db02", "root", "123456");
        Connection connection = DriverManager.getConnection("jdbc:mysql:///java147_db02", "root", "123456");

        // 1.3获取SQL语句执行对象 Statement
        Statement statement = connection.createStatement();

        // 2.执行SQL语句
        // 需求：修改用户表id为1的密码
        int i = statement.executeUpdate("update user set password = '123456' where id = 1");
    ...
    public void testSelect2(String uname,String pwd) throws Exception {
        ...
        // 1.3获取SQL语句执行对象 Statement -- ? 代表占位符
